...
test_regression.relatedness <- svTest(function() {
  ...
  arguments = list(rcont=c(0.923913043478261, 0.565217391304348, 1.0,
                   ...
                   power=-4.35,
                   dropout=c(0.15, 0.01) )
  objectives = c(0.000137489117195194,0.106543997453274,0.0652061299392322,
		0.00129850238984553,0.510379874992622,3.15127470042524e-05,
		1.43398277893768e-06,0.0614748173801719,0.0259185587821221,
		0.000684398079469206)
  names(objectives) = c("D3", "vWA", "D16", "D2", "D8", "D21", "D18", "D19",
                        "TH01", "FGA")
  result <- do.call(likelihood, arguments)
  checkEquals(result$objectives, objectives)
