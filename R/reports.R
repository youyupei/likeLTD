...
output.report <- function(admin,prosecutionHypothesis,defenceHypothesis, prosecutionResults,defenceResults) {
  ...
  administration = data.frame(
	...
	paste(prosecutionResults$member$upper[grep("locusAdjustment",names(prosecutionResults$member$upper))]),
	paste(prosecutionResults$member$lower[grep("locusAdjustment",names(prosecutionResults$member$lower))]),
	paste(prosecutionResults$member$upper[grep("power",names(prosecutionResults$member$upper))]),
	paste(prosecutionResults$member$lower[grep("power",names(prosecutionResults$member$lower))]),
	paste(prosecutionResults$member$upper[grep("dropout",names(prosecutionResults$member$upper))]),
	paste(prosecutionResults$member$lower[grep("dropout",names(prosecutionResults$member$lower))]),
	paste(prosecutionResults$member$upper[grep("degradation",names(prosecutionResults$member$upper))]),
	paste(prosecutionResults$member$lower[grep("degradation",names(prosecutionResults$member$lower))]),
	paste(prosecutionResults$member$upper[grep("rcont",names(prosecutionResults$member$upper))]),
	paste(prosecutionResults$member$lower[grep("rcont",names(prosecutionResults$member$lower))]),
	paste(defenceResults$member$upper[grep("locusAdjustment",names(defenceResults$member$upper))]),
	paste(defenceResults$member$lower[grep("locusAdjustment",names(defenceResults$member$lower))]),
	paste(defenceResults$member$upper[grep("power",names(defenceResults$member$upper))]),
	paste(defenceResults$member$lower[grep("power",names(defenceResults$member$lower))]),
	paste(defenceResults$member$upper[grep("dropout",names(defenceResults$member$upper))]),
	paste(defenceResults$member$lower[grep("dropout",names(defenceResults$member$lower))]),
	paste(defenceResults$member$upper[grep("degradation",names(defenceResults$member$upper))]),
	paste(defenceResults$member$lower[grep("degradation",names(defenceResults$member$lower))]),
	paste(defenceResults$member$upper[grep("rcont",names(defenceResults$member$upper))]),
	paste(defenceResults$member$lower[grep("rcont",names(defenceResults$member$lower))]),
