...
output.report <- function(admin,prosecutionHypothesis,defenseHypothesis, prosecutionResults,defenseResults) {
  ...
  administration = data.frame(
	...
	REFname,
	ALLELEname,
	defenseHypothesis$ethnic,
	#initiated,
	endTime,
	prosecutionHypothesis$adj,
	prosecutionHypothesis$fst,
	prosecutionHypothesis$relatedness[1],
	prosecutionHypothesis$relatedness[2],
	Nknd,
	Nkdo,
	defenseHypothesis$nUnknowns,	
	prosecutionHypothesis$nUnkowns,
	prosecutionHypothesis$doDropin,
