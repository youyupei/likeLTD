...
print(paste("Number of threads", .Call(.cpp.nbthreads, PACKAGE="likeLTD")))
print("PROSECUTION -- unknown=0, doDropin=TRUE")
print(bench.prosecution(nUnknowns=0, doDropin=TRUE))
print("")
print("")
print("PROSECUTION -- unknown=1, doDropin=TRUE")
print(bench.prosecution(nUnknowns=1, doDropin=TRUE))
print("")
print("")
print("PROSECUTION -- unknown=2, doDropin=TRUE")
print(bench.prosecution(nUnknowns=2, doDropin=TRUE))
print("")
print("")
print("PROSECUTION -- unknown=3, doDropin=TRUE")
